                ...
                <Tabs defaultValue="operations" className="w-full" onValueChange={setActiveTab}>
                    <FadeIn delay={0.1}>
                        <div className="flex justify-center mb-12">
                            <TabsList className="bg-white border border-neutral-200 p-1 rounded-full h-auto shadow-sm">
                                <TabsTrigger
                                    value="operations"
                                    className="rounded-full px-6 py-3 text-sm font-medium data-[state=active]:bg-neutral-900 data-[state=active]:text-white transition-all"
                                >
                                    Operations
                                </TabsTrigger>
                                <TabsTrigger
                        ...
                        <FadeIn delay={0.2} className="min-h-[300px]">
                            <AnimatePresence mode="wait">
                                ...
                                >
                                    ...
                                    <h3 className="mt-4 text-3xl font-bold tracking-tight text-neutral-900">
                                    ...
                                    <div className="mt-8 p-6 bg-white rounded-xl border border-neutral-200 shadow-sm">
                                        <p className="font-medium text-neutral-900 flex items-center gap-3">
                        ...
                        <FadeIn delay={0.3}>
                            <AnimatePresence mode="wait">
                                <motion.div
                                    ...
                                    exit={{ opacity: 0, y: -20 }}
                                    transition={{ duration: 0.3 }}
                                    className="rounded-2xl border border-neutral-200 bg-white shadow-xl overflow-hidden"
                                >
                                    <div className="grid grid-cols-3 bg-neutral-50/50 border-b border-neutral-100 p-4">
                                        <div className="text-xs font-semibold text-neutral-900 uppercase tracking-wider">Feature</div>
                                        <div className="text-xs font-semibold text-neutral-500 uppercase tracking-wider">Traditional</div>
                                    ...
                                    <div className="divide-y divide-neutral-100">
                                        {comparisonData[activeTab as keyof typeof comparisonData].map((row, i) => (
                                            <div key={i} className="grid grid-cols-3 p-4 items-center hover:bg-neutral-50 transition-colors">
                                                <div className="font-medium text-sm text-neutral-900 pr-2">{row.step}</div>
                                                <div className="text-sm text-neutral-500 flex items-center gap-2 pr-2">
                                                    {row.manual}
                                                </div>
