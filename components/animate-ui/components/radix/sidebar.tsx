...
interface AppSidebarProps extends React.ComponentProps<typeof SidebarPrimitive> {
  userData: {
    firstName: string;
    lastName: string;
    email: string;
...
function Sidebar({ userData, ...props }: AppSidebarProps) {
        ...
        <SidebarMenu>
          <SidebarMenuItem>
            <div className="flex items-center justify-between px-2 py-2 group-data-[collapsible=icon]:justify-center">
              <span className="text-xs text-muted-foreground font-medium group-data-[collapsible=icon]:hidden">Theme</span>
              <ModeToggle />
            </div>
          </SidebarMenuItem>
          <SidebarMenuItem>
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                ...
                >
                  ...
                  <div className="grid flex-1 text-left text-sm leading-tight group-data-[collapsible=icon]:hidden">
                    <span className="truncate font-semibold">{userData.firstName} {userData.lastName}</span>
              ...
              >
                ...
                <DropdownMenuSeparator />
                <DropdownMenuItem className="text-red-600 dark:text-red-400 focus:text-red-600 focus:bg-red-50 dark:focus:bg-red-950/50 cursor-pointer">
